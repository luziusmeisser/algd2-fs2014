...
public class LinkedListTest {
    ...
    public void setUp() throws Exception {
        ...
        lists.add(new ch.fhnw.algd2.florianfankhauser.lesson1.LinkedList<Integer>());
        ...
        lists.add(new ch.fhnw.algd2.stephenrandles.lesson01.LinkedList<Integer>());
        ...
        lists.add(new ch.fhnw.algd2.lukasmusy.LinkedList<Integer>());
        lists.add(new ch.fhnw.algd2.martineberle.LinkedList<Integer>());
        lists.add(new ch.fhnw.algd2.marcogaiffi.LinkedList<Integer>()); 
